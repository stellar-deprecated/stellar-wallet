 ...
 * - user wants to turn off TOTP authentication: in this case a request contains totpCode
 *   and if it's correct we set totpKey to null,
 * - user lost TOTP device: in this case a request doesn't contain totpCode and
 *   we start grace period.
 */
